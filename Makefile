...
project = Hofmann_Litaniae_in_B
notes = clno1 clno2 timp vl1 vl2 vla1 vla2 S A T B org
scores = full_score ottoni vl1 vl2 vla1 vla2 coro b org
...
archive:
	...
	notes/*.ly scores/*.ly \
	front_matter/byncsaeu.pdf front_matter/logo_full.pdf front_matter/*.tex
